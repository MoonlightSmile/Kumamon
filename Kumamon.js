...
const hideBtn = document.querySelector("span.btn.hide");
const showBtn = document.querySelector("span.btn.show");
...
audioAutoPlay('audio');
},{"prismjs":6,"./css/main.css":4}],8:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '50004' + '/');
